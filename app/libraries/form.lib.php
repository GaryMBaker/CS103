...
class Form {
	...
	*	
	*/
	public static function open($action = '', $extras = []){
	...
	*	
	*/
	public static function search($name, $value = '', $extras = []){
		$html = self::input('search', $name, $value, $extras);
		return $html;
	}
